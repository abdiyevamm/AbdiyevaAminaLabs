            ...
            if event.type == pygame.MOUSEBUTTONUP:
                if drawing_shape == 'rectangle' and event.button == 1:
                    ...
                    pygame.draw.polygon(screen, (255, 255, 0),
                                        [start, (end[0], start[1]), ((start[0] + end[0]) // 2, int(start[1] + height))],
                                        100)
                    ...
                    pygame.draw.polygon(screen, (255, 255, 0),
                                        [(center_x, start[1]), (end[0], center_y), (center_x, end[1]),
                                         (start[0], center_y)], 100)
            ...
            if event.type == pygame.MOUSEMOTION:
                if erasing:
                    ...
                    points = [p for p in points if
                              pygame.math.Vector2(p).distance_to(pygame.math.Vector2(position)) > radius]
                else:
...
def drawShape(screen, start, end, width, color_mode, shape):
    ...
    if shape == 'rectangle':
        ...
        height = math.sqrt(3) / 2 * abs(start[0] - end[0])
        pygame.draw.polygon(screen, (255, 255, 0),
                            [start, (end[0], start[1]), ((start[0] + end[0]) // 2, int(start[1] + height))], 10)
    elif shape == 'rhombus':
        center_x = (start[0] + end[0]) // 2
        center_y = (start[1] + end[1]) // 2
        width = abs(start[0] - end[0])
        height = abs(start[1] - end[1])
        pygame.draw.polygon(screen, (255, 255, 0),
                            [(center_x, start[1]), (end[0], center_y), (center_x, end[1]), (start[0], center_y)], 10)
